...
public class WebData {
    ...
    public void fetch() throws Exception { // fetch data and create ArrayList
        try {
            // Coin Data      
            URL url = URI.create("https://api.coinmarketcap.com/v1/ticker/?convert=" + Main.currency + "&limit=0").toURL();
            ...
            // Global Data
            url = URI.create("https://api.coinmarketcap.com/v1/global/?convert=" + Main.currency).toURL();
    ...
    public static class RefreshCoins implements Runnable { // manually refresh with online API
        public RefreshCoins() {
    ...
    @SuppressWarnings("unchecked") // coin = (ArrayList<Coin> in.readObject()) suppressing
